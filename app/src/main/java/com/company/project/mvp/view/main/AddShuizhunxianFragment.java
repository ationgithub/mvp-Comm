...
import com.company.project.mvp.contract.AddYusheshuizhunxianContract;
import com.company.project.mvp.model.entity.db.YusheshuizhunxianData;
import com.company.project.mvp.presenter.AddYusheshuizhunxianPresenter;
import com.company.project.mvp.view.adapter.Decoration;
import com.company.project.mvp.view.adapter.ItemDragAdapter;
...
//        mRecyclerView.addItemDecoration(new GridItemDecoration(this ,R.drawable.list_divider));
    ...
    private void save() {
        ...
        mYusheshuizhunxianData.setXianluxinxi(String.valueOf(sb));
        KLog.e(TAG,"sb=:"+String.valueOf(sb));
