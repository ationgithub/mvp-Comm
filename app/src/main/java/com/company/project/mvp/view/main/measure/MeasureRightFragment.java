package com.company.project.mvp.view.main.measure;
...
import com.company.project.common.AudioPlayer;
...
import com.company.project.mvp.contract.measure.MeasureContract;
...
import com.company.project.mvp.presenter.measure.MeasureRightPresenter;
import com.company.project.mvp.view.adapter.MeasureRVPAdapter;
...
public class MeasureRightFragment extends BaseFragment<MeasureContract.Presenter> implements MeasureContract.View {
    ...
    public void saveResult(){
        DialogHelper.successSnackbar(viewGroup, "平差完成,成果数据保存成功", DialogHelper.APPEAR_FROM_TOP_TO_DOWN);
